  ...
  return [
    {
      id: 'user_admin',
      username: 'admin',
      passwordHash: bcrypt.hashSync(plainPasswords.admin, 10),
      role: 'admin',
      stallId: null,
    ...
    },
    {
      id: 'user_pastel',
      username: 'pastel',
      passwordHash: bcrypt.hashSync(plainPasswords.pastel, 10),
      role: 'stall',
      stallId: 'pastel',
    ...
    },
    {
      id: 'user_churrasco',
      username: 'churrasco',
      passwordHash: bcrypt.hashSync(plainPasswords.churrasco, 10),
      role: 'stall',
      stallId: 'churrasco',
    ...
    },
    {
      id: 'user_doces',
      username: 'doces',
      passwordHash: bcrypt.hashSync(plainPasswords.doces, 10),
      role: 'stall',
      stallId: 'doces',
