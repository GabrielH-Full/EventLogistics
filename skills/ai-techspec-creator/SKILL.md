...
- Realizar análise ampla: chamadores/chamados, configs, middleware, persistência, concorrência, tratamento de erros,
  testes, infra
...
- Mapear decisões em ADRs usando o template `templates/adr-template.md`
- Destacar desvios com justificativa e alternativas conformes
- Use o SEMPRE MCP do Context7 para requisitos técnicos e práticas recomendadas ou consulte na Web

### 6. Gerar Tech Spec (Obrigatório)

- Usar `templates/techspec-template.md` como estrutura exata
- Fornecer: visão geral da arquitetura, design de componentes, interfaces, modelos, endpoints, pontos de integração,
  análise de impacto, estratégia de testes, observabilidade
